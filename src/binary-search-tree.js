...
class BinarySearchTree {
  ...
  add(data) {
    this.rootName = addWithin(this.rootName, data)
  ...
  has(data) {
   return searchWithin(this.rootName, data)
  ...
  find(data) {
    return findNode(this.rootName, data);
  ...
  remove(data) {
    this.rootName = removeNode(this.rootName, data)
